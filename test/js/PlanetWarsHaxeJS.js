...
com.tamina.planetwars.core.GameEngine.prototype = {
	...
	,resolveConflict: function(attacker,defender) {
		...
		if(attacker.owner == defender.owner) defender.population += attacker.crew; else if(result > 0) {
			...
			haxe.Log.trace("planet captured by " + attacker.owner.name + " with over " + Std.string(result) + " on " + defender.owner.name,{ fileName : "GameEngine.hx", lineNumber : 160, className : "com.tamina.planetwars.core.GameEngine", methodName : "resolveConflict"});
